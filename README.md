...
预编译二进制可执行文件可在 [Release 页面](https://github.com/mzxk/trojan-go/releases)下载。解压后即可直接运行，无其他组件依赖。
...
- [Igniter-Go](https://github.com/mzxk/trojan-go-android)：Android 客户端，Fork 自 Igniter，将 Igniter 核心替换为 Trojan-Go 并做了一定修改，支持所有 Trojan-Go 扩展特性。
...
```shell
git clone https://github.com/mzxk/trojan-go.git
cd trojan-go
make
