...
import (
	...
	"github.com/mzxk/trojan-go/tunnel/adapter"
	"github.com/mzxk/trojan-go/tunnel/http"
	"github.com/mzxk/trojan-go/tunnel/mux"
	"github.com/mzxk/trojan-go/tunnel/router"
	"github.com/mzxk/trojan-go/tunnel/shadowsocks"
	"github.com/mzxk/trojan-go/tunnel/simplesocks"
	"github.com/mzxk/trojan-go/tunnel/socks"
	"github.com/mzxk/trojan-go/tunnel/tls"
	"github.com/mzxk/trojan-go/tunnel/transport"
	"github.com/mzxk/trojan-go/tunnel/trojan"
